...
dependencies {
    ...
    // Baseline Profile: profileinstaller lets the ahead-of-time profile ship in the APK and be
    // installed at first run; baselineProfile() consumes the profile generated by :baselineprofile.
